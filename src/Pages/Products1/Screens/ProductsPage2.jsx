...
function ProductsPage2() {
  ...
  const handleChangeSort = async (sortValue) => {
    ...
    if (sortValue == "newest") {
      ...
      const newProducts = axios
        .get(
          "https://dialuxury.onrender.com/product/category/newest/D%C3%A2y%20chuy%E1%BB%81n"
        )
        .then((response) => {
    ...
    if (sortValue == "ascending") {
      ...
      const newProducts = axios
        .get(
          "https://dialuxury.onrender.com/product/category/ascendingPrice/D%C3%A2y%20chuy%E1%BB%81n"
        )
        .then((response) => {
          console.log(response.data);
    ...
    if (sortValue == "mostSold") {
      ...
      const newProducts = axios
        .get(
          "https://dialuxury.onrender.com/product/category/mostSold/D%C3%A2y%20chuy%E1%BB%81n"
        )
        .then((response) => {
          console.log(response.data);
          filterProducts(response.data);
    ...
    if (sortValue == "") {
      ...
      const newProducts = axios
        .get(
          "https://dialuxury.onrender.com/product/category/D%C3%A2y%20chuy%E1%BB%81n"
        )
        .then((response) => {
          console.log(response.data);
          console.log(sortValue);
  ...
  const images = [
    ...
    "https://cdn.pnj.io/images/promo/193/BANNER_OMNI_ROSA__1200x450_.png",
