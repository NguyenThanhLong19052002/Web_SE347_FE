...
function ProductsPage() {
  ...
  const handleChangeSort = async (sortValue) => {
    ...
    if (sortValue == "newest") {
      ...
      const newProducts = axios
        .get(
          "https://dialuxury.onrender.com/product/category/newest/Nh%E1%BA%ABn"
        )
        .then((response) => {
    ...
    if (sortValue == "descending") {
      ...
      const newProducts = axios
        .get(
          "https://dialuxury.onrender.com/product/category/descendingPrice/Nh%E1%BA%ABn"
        )
        .then((response) => {
          console.log(response.data);
          filterProducts(response.data);
    ...
    if (sortValue == "ascending") {
      ...
      const newProducts = axios
        .get(
          "https://dialuxury.onrender.com/product/category/ascendingPrice/Nh%E1%BA%ABn"
        )
        .then((response) => {
          console.log(response.data);
    ...
    if (sortValue == "mostSold") {
      ...
      const newProducts = axios
        .get(
          "https://dialuxury.onrender.com/product/category/mostSold/Nh%E1%BA%ABn"
        )
        .then((response) => {
          console.log(response.data);
          filterProducts(response.data);
  ...
  const images = [
    "https://theme.hstatic.net/200000061680/1000549213/14/2banner_top_img.png?v=754",
