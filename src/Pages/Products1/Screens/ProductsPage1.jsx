...
function ProductsPage1() {
  ...
  const handleChangeSort = async (sortValue) => {
    ...
    if (sortValue == "newest") {
      ...
      const newProducts = axios
        .get(
          "https://dialuxury.onrender.com/product/category/newest/B%C3%B4ng%20tai"
        )
        .then((response) => {
    ...
    if (sortValue == "ascending") {
      ...
      const newProducts = axios
        .get(
          "https://dialuxury.onrender.com/product/category/ascendingPrice/B%C3%B4ng%20tai"
        )
        .then((response) => {
          console.log(response.data);
    ...
    if (sortValue == "mostSold") {
      ...
      const newProducts = axios
        .get(
          "https://dialuxury.onrender.com/product/category/mostSold/B%C3%B4ng%20tai"
        )
        .then((response) => {
          console.log(response.data);
          filterProducts(response.data);
  ...
  const images = [
    ...
    "https://cdn.pnj.io/images/promo/141/Banner_Bong_Tai_1200x450.jpg",
