    ...
    <Container fluid>
      ...
      <Row className="pt-5 pb-5 container-row">
        <div className="container-padding">
          <div className="title-h2 ">
            <h2>Nhẫn</h2>
            <Link to="/products/nhan" className="see-all">
              Xem tất cả
            </Link>
          </div>
          <Image src="https://theme.hstatic.net/200000061680/1000549213/14/2banner_top_img.png?v=754" className="w-100" />
      ...
      <Row className="pt-5 pb-5 container-row">
        <div className="container-padding">
          <div className="title-h2 height-odd">
            <h2>Dây chuyền</h2>
            <Link to="/products/day-chuyen" className="see-all">
              Xem tất cả
            </Link>
          </div>
          <Image src="https://file.hstatic.net/200000627539/collection/daychuyen-01_b61b4057724a41c9a4a8920991b864dc.png" className="w-100" />
      ...
      <Row className="pt-5 pb-5 container-row">
        <div className="container-padding">
          <div className="title-h2">
            <h2>Bông tai</h2>
            <Link to="/products/bong-tai" className="see-all">
              Xem tất cả
            </Link>
          </div>
          <Image src="https://cdn.pnj.io/images/promo/141/Banner_Bong_Tai_1200x450.jpg" className="w-100" />
